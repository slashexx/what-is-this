...
const VendorDetails = ({ selectedVendor, handleBackToList }) => {
  ...
  return (
    <div className="bg-white sm:px-6 px-2 pt-2 rounded-lg shadow-md">
      <button
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 md:gap-8 gap-0 rounded-lg">
        <div className="grid grid-cols-2 gap-4 mt-6">
          ...
          <p className="text-sm font-medium text-gray-500">Total Products</p>
            ...
            <p className="text-sm font-medium text-gray-500 mt-4">Total Products</p>
      ...
      {/* Vendor Products */}
      <div className="mt-8">
        <VendorProductsTable vendorId={selectedVendor.id} />
      </div>
    </div>
  );
};
